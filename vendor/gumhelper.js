(function () {
    ...
    /**
     * Requests permission for using the user's camera.svg,
     * starts reading video from the selected camera.svg, and calls
    ...
    function startVideoStreaming(callback, options) {
        ...
        if(navigator.mediaDevices.getUserMedia || navigator.getMedia) {
            ...
            startStreaming(function() {
                    ...
                    // ERROR!!!
                    callback(new Error('getUserMedia cannot access the camera.svg'));
